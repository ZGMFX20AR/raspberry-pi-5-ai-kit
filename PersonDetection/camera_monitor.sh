...
rpicam-hello -v 2 -t 0 --post-process-file /home/raspberry/hailo_yolov6_inference.json --lores-width 640 --lores-height 640 2>&1 | grep --line-buffered -E 'Object.*person|person.*Object' | while IFS= read -r line; do
